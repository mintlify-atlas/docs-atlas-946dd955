---
title: "Get Started with Balsamoa Backend in 5 Minutes"
...
<Steps>
  ...
  <Step title="Verify the server is working">
    ...
    curl http://localhost:3000/api/v1/tienda/productos

    # Fetch a single product by ID
    curl http://localhost:3000/api/v1/tienda/productos/1
    ```
