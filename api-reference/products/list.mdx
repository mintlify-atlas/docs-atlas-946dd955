---
title: "GET /api/v1/admin/productos — List All Admin Products"
sidebarTitle: "List Products"
description: "GET /api/v1/admin/productos — Returns all products from the catalog view with images, variants, stock totals, and color hex codes, ordered by ID DESC."
---
