...
description: "Balsamoa Backend is an Express REST API for the Balsamoa clothing store: catalog management, size and color inventory, image uploads, and an admin panel."
---
