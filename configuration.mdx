...
description: "Balsamoa Backend reads DATABASE_URL and PUERTO from a .env file. Learn what each variable does and how to configure them for development and production."
---
...
```javascript src/config/conexion.bd.mjs
const pool = new Pool({
