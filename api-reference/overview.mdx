---
title: "Balsamoa API Reference: REST Endpoints Overview"
...
No token-based authentication is currently implemented. Admin endpoints are accessible to any client that can reach the server. Before deploying to production, restrict all traffic to `/api/v1/admin/*` at the reverse-proxy (e.g. Nginx or Caddy) or Express middleware level — for example by checking a shared secret header or by placing the admin panel behind a VPN.
